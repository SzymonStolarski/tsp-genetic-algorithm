...
class ElitismSelector(BaseSelector):
    ...
    def selection(self, population: dict, evaluated_population: dict,
        ...
        if len(selected_individuals_keys) < len(evaluated_population):
            difference = (len(evaluated_population)-len(selected_individuals_keys))
            selected_individuals_keys.extend(selected_individuals_keys[:difference])

        selected_population = self._select_population(population,
